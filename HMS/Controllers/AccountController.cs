...
namespace HMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewData["ReturnUrl"] = returnUrl;
            ViewBag.ddlManageUserRoles = new SelectList(_iCommon.GetTableData<ManageUserRoles>(_context), "Id", "Name");
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<JsonResult> Register(UserProfileCRUDViewModel _UserProfileViewModel)
        {
            JsonResultViewModel _JsonResultViewModel = new();
            try
            {
                _UserProfileViewModel.RoleId = 2;
                ...
                if (_ApplicationUser.Item2 == "Success")
                {
                    ...
                    _JsonResultViewModel.ModelObject = _ApplicationUser.Item1;
                    return new JsonResult(_JsonResultViewModel);
                }
                else
                {
