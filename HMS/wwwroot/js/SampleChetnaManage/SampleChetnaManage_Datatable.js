...
$(document).ready(function () {
    document.title = 'Sample Chetna Manage';

    $("#tblDataSampleChetnaManage").DataTable({
        paging: true,
        select: true,
        "order": [[0, "desc"]],
        dom: 'Bfrtip',
        ...
        "ajax": {
            "url": "/SampleChetnaManage/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            
            {
                data: "ProfilePicture","name": "ProfilePicture", render: function (data, type, row) {
                    return "<div><img src='" + row.ProfilePicture + "' class='img-circle elevation-2 imgCustom' alt='Image' /></div>";
                }
            },
